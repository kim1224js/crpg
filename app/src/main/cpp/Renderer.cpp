...
void Renderer::createModels() {
     ...
     * 3 --- 2
     */
    EGLint surfaceWidth = 1;
    EGLint surfaceHeight = 1;
    ...
    const float halfWidth = halfHeight * static_cast<float>(surfaceWidth)
                            / static_cast<float>(surfaceHeight);

    std::vector<Vertex> vertices = {
            Vertex(Vector3{halfWidth, halfHeight, 0}, Vector2{0, 0}), // 0
            Vertex(Vector3{-halfWidth, halfHeight, 0}, Vector2{1, 0}), // 1
            Vertex(Vector3{-halfWidth, -halfHeight, 0}, Vector2{1, 1}), // 2
            Vertex(Vector3{halfWidth, -halfHeight, 0}, Vector2{0, 1}) // 3
    };
    ...
    auto villageTexture = TextureAsset::loadAsset(assetManager, "ui/village/village_map.png");

    // Create a model and put it in the back of the render list.
    models_.emplace_back(vertices, indices, villageTexture);
}
